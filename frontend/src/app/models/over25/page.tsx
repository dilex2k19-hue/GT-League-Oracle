...
export default function Over25Page() {
  ...
  useEffect(() => {
    setLoading(true);
    const targetModel = encodeURIComponent("Over 2.5");
  ...
  const columns: ColumnDef<Prediction>[] = [
    ...
    },
    {
      ...
      align: "center",
      render: (row) => (
        <span className="font-mono font-semibold text-emerald-400/80 bg-slate-950 px-2 py-1 border border-slate-800 rounded text-xs">
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      <header className="border-b border-slate-800 pb-4 flex justify-between items-end">
        <div>
          ...
          <Zap className="w-8 h-8" /> Over 2.5 Goals Model
          </h1>
          <p className="text-slate-400 text-xs mt-1">Specialized metrics and recent historical performance.</p>
        </div>
        ...
        <div className="flex flex-col items-end gap-2">
            ...
            <div className="flex items-center gap-3">
                ...
                <input 
                    ...
                    className="bg-slate-900 border border-slate-700 text-slate-200 text-sm rounded-lg px-3 py-1.5 outline-none focus:border-emerald-500 transition-colors [color-scheme:dark]"
                />
            </div>
        </div>
      </header>
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-slate-900 p-5 rounded-xl border border-slate-800 shadow-xl relative overflow-hidden">
                ...
                <div className="flex items-end gap-2 mb-6">
                    <span className="text-4xl font-mono font-bold text-emerald-400">{winRate}%</span>
