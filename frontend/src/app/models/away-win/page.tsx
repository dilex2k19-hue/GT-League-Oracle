...
export default function AwayWinPage() {
  ...
  useEffect(() => {
    setLoading(true);
    const targetModel = encodeURIComponent("Away Win");
  ...
  const columns: ColumnDef<Prediction>[] = [
    ...
    },
    {
      ...
      align: "center",
      render: (row) => (
        <span className="font-mono font-semibold text-purple-400/80 bg-slate-950 px-2 py-1 border border-slate-800 rounded text-xs">
      ...
      <header className="border-b border-slate-800 pb-4 flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-bold text-purple-400 flex items-center gap-3">
           <Rocket className="w-8 h-8" /> Away Win Exploits
          </h1>
          <p className="text-slate-400 text-xs mt-1">Monitoring away-side anomalies and high-margin underdog setups.</p>
        </div>
        ...
        <div className="flex flex-col items-end gap-2">
            ...
            <div className="flex items-center gap-3">
                ...
                <input 
                    ...
                    className="bg-slate-900 border border-slate-700 text-slate-200 text-sm rounded-lg px-3 py-1.5 outline-none focus:border-purple-500 transition-colors [color-scheme:dark]"
                />
            </div>
        </div>
      </header>
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-slate-900 p-5 rounded-xl border border-slate-800 shadow-xl relative overflow-hidden">
                ...
                <div className="flex items-end gap-2 mb-6">
                    <span className="text-4xl font-mono font-bold text-purple-400">{winRate}%</span>
